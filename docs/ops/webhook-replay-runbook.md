...
Optional non-production rehearsal command:

```bash
ARTIFACT_DIR=/tmp/stage1_item3_incident_runbook_exercise_automated APP_URL=http://localhost:3100 pnpm rehearse:incident:runbooks
```
