...
| 3 | PENDING | `pnpm ci:check`, incident runbook walkthrough checks | `docs/ops/webhook-replay-runbook.md` (added), walkthrough evidence pending | Pending | Webhook replay runbook completed for this PR chunk; provider outage + token/billing runbooks and walkthrough rehearsal remain. |
