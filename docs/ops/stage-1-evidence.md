...
| 3 | PENDING | `pnpm ci:check`, incident runbook walkthrough checks | `docs/ops/token-billing-incident-runbook.md` (added), walkthrough evidence pending | Pending | Token/billing incident runbook completed for this PR chunk; remaining Item 3 runbooks and walkthrough rehearsal/signoff still pending. |
