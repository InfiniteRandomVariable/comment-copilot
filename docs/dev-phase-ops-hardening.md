...
- `docs/ops/production-deploy-dry-run-log-template.md`
...
- Item 4 (deploy/env checklist): In Progress | Tests Passed: Partial | Evidence Linked: Partial | Owner Signoff: No
